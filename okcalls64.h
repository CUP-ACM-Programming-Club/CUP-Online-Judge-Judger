 ...
 */
//c & c++
int LANG_CV[256] = {0, 1, 2, 3, 4, 5, 8, 9, 11, 12, 20, 21, 59, 63, 89, 158, 231, 240, SYS_time, SYS_read, SYS_uname,
                    SYS_write, SYS_open,
...
//pascal
int LANG_PV[256] = {0, 1, 2, 3, 4, 9, 11, 13, 16, 59, 89, 97, 201, 231, SYS_open, SYS_set_thread_area, SYS_brk,
                    SYS_read,
...
int LANG_JV[256] = {0, 2, 3, 4, 5, 9, 10, 11, 12, 13, 14, 21, 56, 59, 89, 97, 104, 158, 202, 218, 231, 273, 257,
                    61, 22, 6, 33, 8, 13, 16, 111, 110, 157, 39, 79, SYS_fcntl,
...
//bash
int LANG_BV[256] = {0, 1, 2, 3, 4, 5, 8, 9, 10, 12, 13, 14, 16, 21, 33, 39, 59, 63, 72, 79, 97, 99, 102, 104, 107, 108,
                    110, 111, 158, 231,
...
//python
int LANG_YV[256] = {0, 1, 2, 3, 4, 5, 6, 8, 9, 10, 12, 13, 14, 16, 21, 59, 78, 79, 89, 97, 99, 102, 104, 107, 108, 158,
                    218, 231, 273, 32, 72, 131, 1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 13, 14, 16, 21, 59, 78, 79, 89, 97,
                    102, 104, 107, 108, 158, 202, 218, 231, 257, 273, 41, 42, 146, SYS_mremap, 158, 117, 60, 39, 102,
                    191, 318,
                    ...
                    SYS_write, 0};
//pypy
int LANG_PYV[256] = {0, 1, 2, 3, 4, 5, 6, 9, 10, 11, 12, 13, 14, 16, 21, 59, 63, 97, 137, 158, 218, 231, 273,
                     SYS_mremap, 158, 117, 60, 39, 102, 191, 318,
                     SYS_access, SYS_arch_prctl, SYS_brk, SYS_close, SYS_execve,
                     SYS_exit_group, SYS_fcntl, SYS_fstat, SYS_futex, SYS_getcwd,
                     SYS_getdents, SYS_getegid, SYS_geteuid, SYS_getgid, SYS_getrlimit,
                     SYS_getuid, SYS_ioctl, SYS_lseek, SYS_lstat, SYS_mmap, SYS_mprotect,
                     ...
                     SYS_write, 0};
//php
int LANG_PHV[256] = {0, 1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 13, 14, 16, 21, 28, 59, 79, 97, 137, 158, 202, 218, 231,
                     257, 273,
...
int LANG_CSV[256] = {0, 1, 2, 3, 4, 5, 8, 9, 10, 11, 12, 13, 14, 16, 21, 24, 41, 42, 56, 59, 63, 72, 78, 79, 89, 97,
                     102, 131, 137, 158, 202, 204, 218, 229, 231, 234, 257, 273, 257, 141, 95, 64, 65, 66, 83, 24, 42,
                     41, 158, 117, 60,
...
//nodejs javascript
int LANG_JSV[256] = {0, 1, 2, 3, 4, 5, 6, 9, 10, 11, 12, 13, 14, 16, 21, 56, 59, 79, 89, 96, 97, 158, 186, 202, 218,
                     228, 231, 232, 233, 273, 290, 291, 293, 0};
//go-lang
